...
<a href="Cmember.jsp" class="made-with-mk">
				...
				<div class="col-lg-6 col-lg-offset-3"  style="width:80%;float:none;margin:auto;" >
					<div class="login-content">
						<div class="login-form">
							...
							<form name="form" action="updatemem1" >
                              <table class=" table-responsive table-bordered">
							<tbody>
<%
				            Vector<String> v1=new Vector<String>();
				            String[] temp=request.getParameterValues("MnoAno");//获取从页面传来的参数
						   memberDTO m=null;
						   String[] MA=temp[0].split(",");
						   for(String a:MA){
							   v1.add(a);
						   }
						   String Mno=v1.firstElement();
						   String Ano=v1.lastElement();
				       //
    	 
%>
                       <sql:query var="result" dataSource="${mydb}" >
			             select * from members where Ano='<%=Ano%>' and Mno='<%=Mno%>';
			            </sql:query>
			            <thead>
			             <c:forEach var="re" items="${result.rows}">
								<div class="col-sm-5 col-sm-offset-1">
                              	<div class="form-group label-floating">
									<label>学生编号：</label>
							<input type="text" name="Mno" readonly="true" value="${re.Mno}"  class="form-control">
								</div>	
								</div>
								<div class="col-sm-5">
                              	<div class="form-group label-floating">
									<label>用户名：</label>
							<input type="text" name="Sname" value="${re.Sname}" class="form-control">
								</div>
								</div>
								...
								<div class="col-sm-5 col-sm-offset-1" >
                              	<div class="form-group label-floating">
									<label>密码：</label>
									<input type="text" name="password" value="${re.password}" class="form-control">
								</div>
								</div>
								<div class="col-sm-5 " >
                              	<div class="form-group label-floating">
									<label>年龄：</label>
									<input type="text" name="Age" value="${re.Age}"  class="form-control">					
                                 </div>
                                 </div>
                                 <div class="col-sm-5 col-sm-offset-1" >
                              	<div class="form-group label-floating">
									<label>性别：</label>
									<input type="text" name="Gender" value="${re.Gender}"  class="form-control">					
                                 </div>
                                 </div>
                                <div class="col-sm-5 ">
                              	<div class="form-group label-floating">
                              	<label>学院：</label>
                                   <input type="text" name="Depart" value="${re.Depart}"  class="form-control">
                                	</div>
                                </div>
                                <div class="col-sm-5 col-sm-offset-1" >
                              	<div class="form-group label-floating">
                                 	...
                                 	<label >社团</label>
                                 	<input type="text" name="Ano" value="${re.Ano}" class="form-control">
                                	</div>
                                </div>
                               ...
                               <div class="col-sm-5 ">
                              	<div class="form-group label-floating">
                                    	<label >职位</label>
                                    	<input type="text" name="Title" value="${re.Title}" class="form-control">
                              ...
                              <div class="col-sm-5 col-sm-offset-1" >
                              	<div class="form-group label-floating">
                                    	<label >权限</label>
                                    <input type="text" name="sSuper" readonly="true" value="${re.sSuper}" class="form-control">
                                	</div>
                             
                                </div>
								<button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" onclick="return check4();">修改</button>
