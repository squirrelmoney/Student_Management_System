    ...
    <div class="content-wrap">
        <div class="main">
			...
			<tbody>
             ...
             select * from activities where Ano='<%=session.getAttribute("Ano")%>' and Access='Y';
            </sql:query>
            ...
            <td><c:out value="${re.Mno}"></c:out></td>
             ...
             <td><a href="updateActivities.jsp?f=update&Acno=${re.Acno}">修改</a></td>
			 <td><a href="updateactivities1?f=delete&Acno=${re.Acno}"
