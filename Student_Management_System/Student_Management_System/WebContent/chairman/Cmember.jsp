...
<sql:setDataSource
    ...
    <div class="content-wrap">
        <div class="main">
            ...
            <thead>
			<tr>
			<td><input type="checkbox" name="check" value=${re.Mno}+","+${re.Ano}></td>
            <td><c:out value="${re.Mno}"></c:out></td>
            <td><c:out value="${re.Ano}"></c:out></td>
            <td><c:out value="${re.Sname}"></c:out></td>
            <td><c:out value="${re.Password}"></c:out></td>
            <td><c:out value="${re.Age}"></c:out></td>
            <td><c:out value="${re.Gender}"></c:out></td>
            <td><c:out value="${re.Depart}"></c:out></td>
            <td><c:out value="${re.Title}"></c:out></td>
            <td><c:out value="${re.sSuper}"></c:out></td>
            
            
             <td><a href="updateMem.jsp?f=update&MnoAno=${re.Mno},${re.Ano}">修改</a></td>
			 <td><a href="updatemem1?f=delete&MnoAno=${re.Mno},${re.Ano}"
