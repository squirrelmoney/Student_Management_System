...
<a href="Cactivities.jsp" class="made-with-mk">
	<div class="brand">返回</div>
	<div class="made-with"><strong>上一页</strong>(社团)</div>
</a>
				...
				<div class="col-lg-6 col-lg-offset-3"  style="width:80%;float:none;margin:auto;" >
					<div class="login-content">
						<div class="login-form">
							...
							<form name="form" action="updateactivities1" >
                              <table class=" table-responsive table-bordered">
							<tbody>

                       <sql:query var="result" dataSource="${mydb}" >
			             select * from activities where Acno='<%=request.getParameter("Acno")%>' ;
			            </sql:query>
			            <thead>
			             <c:forEach var="re" items="${result.rows}">
								<div class="col-sm-5 col-sm-offset-1">
                              	<div class="form-group label-floating">
									<label>活动编号：</label>
							<input type="text" name="Acno" readonly="true" value="${re.Acno}"  class="form-control">
								</div>	
								</div>
								<div class="col-sm-5">
                              	<div class="form-group label-floating">
									<label>活动名：</label>
							<input type="text" name="Acname" value="${re.Acname}" class="form-control">
								</div>
								</div>
								...
								<div class="col-sm-5 col-sm-offset-1" >
                              	<div class="form-group label-floating">
									<label>负责人：</label>
									<input type="text" name="Mno" value="${re.Mno}" class="form-control">
								</div>
								</div>
								<div class="col-sm-5 " >
                              	<div class="form-group label-floating">
									<label>社团：</label>
									<input type="text" readonly="true" name="Ano" value="${re.Ano}"  class="form-control">					
                                 </div>
                                 </div>
                                 <div class="col-sm-5 col-sm-offset-1" >
                              	<div class="form-group label-floating">
