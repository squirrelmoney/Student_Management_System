				...
				<div class="col-lg-6 col-lg-offset-3"  style="width:80%;float:none;margin:auto;" >
					<div class="login-content">
						<div class="login-form">
							...
							<form name="form" action="updatedepart" >
					    ...
					    String No=request.getParameter("No");//request.getParameter("##") 是获取上一个页面传入本页面的值
					     while(it.hasNext()){
						   d=it.next();
					       //
			            ...
			            <thead>
								<div class="col-sm-5 col-sm-offset-1">
                              	<div class="form-group label-floating">
									<label>学院编号：</label>
							<input type="text" name="No" readonly="true" value=<%=d.getNo() %>  class="form-control">
								</div>	
								</div>
								<div class="col-sm-5">
                              	<div class="form-group label-floating">
									<label>学院名：</label>
							<input type="text" name="Name" value=<%=d.getName() %> class="form-control">
								</div>
								</div>
		                <%
					       }
								...
								%>
								<button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" onclick="return check();">修改</button>
