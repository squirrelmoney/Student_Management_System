				...
				<div class="col-lg-6 col-lg-offset-3"  style="width:80%;float:none;margin:auto;" >
					<div class="login-content">
						<div class="login-form">
                          ...
                          <form name="form" action="insertActivities" >
								...
								<div class="col-sm-5 col-sm-offset-1">
                              	<div class="form-group label-floating">
									<label>负责人：</label>
									<sql:query var="result1" dataSource="${mydb}" sql="select * from members"/>
                                ...
                                <div class="col-sm-5">
                              	<div class="form-group label-floating">
									<label>所属社团:</label>
								<sql:query var="result" dataSource="${mydb}" sql="select * from associations"/>
								<select name="Ano" class="form-control">
								<c:forEach var="re" items="${result.rows}">
								<option selected value="${re.Ano}"><c:out value="${re.Aname}(${re.Ano})"></c:out></option>
								</c:forEach>
								</select>
								</div>
								</div>
								...
								<button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" onclick="return check2();">添加</button>
