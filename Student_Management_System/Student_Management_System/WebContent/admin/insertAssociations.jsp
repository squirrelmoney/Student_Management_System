				...
				<div class="col-lg-6 col-lg-offset-3"  style="width:80%;float:none;margin:auto;" >
					<div class="login-content">
						<div class="login-form">
							...
							<form name="form" action="insertAssociations" >
								...
								<div class="col-sm-5 col-sm-offset-1">
                              	<div class="form-group label-floating">
									<label>会长：</label>
									<input type="text" readonly="true"  value="null" name="Mno" id="Mno" class="form-control">
								</div>
								</div>
								 <div class="col-sm-5">
                              	 <div class="form-group label-floating">
									...
									<option selected value="${re.No}"><c:out value="${re.No}:${re.Name}"></c:out></option>
									</c:forEach>
									</select>
								...
								<button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" onclick="return check3();">添加</button>
