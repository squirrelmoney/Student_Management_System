										...
										<ul>
											...
											<li class="card-option drop-menu"><i class="ti-settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="link"></i>
												<ul class="card-option-dropdown dropdown-menu">
													<li><a href="insertMember.jsp"><i class="ti-loop"></i> 添加</a></li>
                                    ...
                                    <table class=" table-responsive table-bordered">
                                        <thead>
									       ...
									       <th></th>
									        ...
									        <th>Super</th>
									        <th></th>
   											 <th><a href="#" id="btn2" type="button" value="删除" onclick="deleteMem();">删除所选</a></th>
									          <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                      <%
									   Vector<memberDTO> v=(Vector<memberDTO>)session.getAttribute("allMem");
									   Iterator<memberDTO> it=v.iterator();
									   memberDTO m=null;
									   while(it.hasNext()){
										   m=it.next();
										   if(!m.getMno().equals("20190101")){
									%>
									 <thead>
									      <tr>
									        <td><input type="checkbox" name="check" value=<%=m.getMno()+","+m.getAno()%>></td>
									        <td><%=m.getMno() %></td>
									        <td><%=m.getSname() %></td>
									        <td><%=m.getPassword()%></td>
									        <td><%=m.getAge() %></td>
									        ...
									        <td><%=m.getAno()%></td>
									        <td><%=m.getsSuper()%></td>
									        <td><a href="updateMem.jsp?f=update&MnoAno=<%=m.getMno()+","+m.getAno()%>">修改</a></td>
									        <td><a href="updatemem?f=delete&MnoAno=<%=m.getMno()+","+m.getAno()%>"
