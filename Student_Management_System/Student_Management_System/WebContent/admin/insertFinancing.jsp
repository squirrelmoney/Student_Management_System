				...
				<div class="col-lg-6 col-lg-offset-3"  style="width:80%;float:none;margin:auto;" >
					<div class="login-content">
						<div class="login-form">
							...
							<form name="form" action="insertFinancing" >
								...
								<div class="col-sm-5">
                              	<div class="form-group label-floating">
                                 	<label >请选择活动编号</label>
                                 	<sql:query var="result" dataSource="${mydb}" sql="select * from activities"/>
									<select name="Acno" class="form-control">
									<c:forEach var="re" items="${result.rows}">
									<option selected value="${re.Acno}"><c:out value="${re.Acno}(${re.Ano})"></c:out></option>
									</c:forEach>
                                    </select>
                                	</div>
                                </div>
