...
<a href="allAssociations.jsp" class="made-with-mk">
				...
				<div class="col-lg-6 col-lg-offset-3"  style="width:80%;float:none;margin:auto;" >
					<div class="login-content">
						<div class="login-form">
							...
							<form name="form" action="updateasso" >
                              <table class=" table-responsive table-bordered">
							<tbody>
								<%
								   Vector<associationsDTO> v=(Vector<associationsDTO>)session.getAttribute("allAsso");//getAttribute得到的是对象
								   Iterator<associationsDTO> it=v.iterator();
								   String Ano=request.getParameter("Ano");//request.getParameter("##") 是获取上一个页面传入本页面的值
								   associationsDTO a=null;
								   while(it.hasNext()){
									   a=it.next();
								       //
			            ...
			            <thead>
								<div class="col-sm-5 col-sm-offset-1">
                              	<div class="form-group label-floating">
									<label>社团编号：</label>
							<input type="text" name="Ano" readonly="true" value=<%=a.getAno() %>  class="form-control">
								</div>	
								</div>
								<div class="col-sm-5">
                              	<div class="form-group label-floating">
									<label>社团名：</label>
							<input type="text" name="Aname" value=<%=a.getAname() %> class="form-control">
								</div>
								</div>
								<div class="col-sm-5 col-sm-offset-1">
                              	<div class="form-group label-floating">
								...
								<div class="col-sm-5">
                              	<div class="form-group label-floating">
									<label>学院：</label>
								<input type="text" name="Depart" value=<%=a.getDepart() %> class="form-control">
								</div>
								</div>
		                <%
					       }
						...
						%>
								<button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" onclick="return check3();">修改</button>
