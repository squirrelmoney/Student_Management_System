...
<a href="allFinancing.jsp" class="made-with-mk">
				...
				<div class="col-lg-6 col-lg-offset-3"  style="width:80%;float:none;margin:auto;" >
					<div class="login-content">
						<div class="login-form">
							...
							<form action="updatefinancing" name="form">
							<table  class=" table-responsive table-bordered">
											<%
						 Vector<financingDTO> v=(Vector<financingDTO>)session.getAttribute("allFn");
					     Iterator<financingDTO> it=v.iterator();
					     financingDTO f=null;
					     String Fno=request.getParameter("Fno");//request.getParameter("##") 是获取上一个页面传入本页面的值
					    while(it.hasNext()){
						   f=it.next();
						   if(f.getFno().equals(Fno)){
					%>
			            <thead>
								<div class="col-sm-5 col-sm-offset-1">
                              	<div class="form-group label-floating">
									<label>财务表号：</label>
							<input type="text" name="Fno" readonly="true" value=<%=f.getFno() %> class="form-control">
								</div>	
								</div>
								<div class="col-sm-5">
                              	<div class="form-group label-floating">
									<label>活动号：</label>
							<input type="text" name="Acno"  value=<%=f.getAcno() %> class="form-control">
								</div>
								</div>
								...
								<div class="col-sm-5 col-sm-offset-1" >
                              	<div class="form-group label-floating">
									<label>负责人</label>
									<input type="text" name="Mno" value=<%=f.getMno() %> class="form-control">
								</div>
								</div>
								<div class="col-sm-5 " >
                              	<div class="form-group label-floating">
									<label>费用</label>
									<input type="text" name="Budget"  value=<%=f.getBudget() %> class="form-control">				
                                 </div>
                                 </div>
                                ...
                                <div class="col-sm-5 col-sm-offset-1">
                              	<div class="form-group label-floating">
									<label>是否通过审核：</label>
								<input type="text" name="Access"  value=<%=f.getAccess() %> class="form-control">
								</div>
								</div>
								<button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" onclick="return check1();">修改</button>
