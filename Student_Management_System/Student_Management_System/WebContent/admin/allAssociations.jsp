                            ...
                            <div class="card alert">
										...
										<ul>
											...
											<li class="card-option drop-menu"><i class="ti-settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="link"></i>
												<ul class="card-option-dropdown dropdown-menu">
													<li><a href="insertAssociations.jsp"><i class="ti-loop"></i> 添加</a></li>
                                ...
                                <div class="card-body">
                                    <table class=" table-responsive table-bordered">
                                        <thead>
                                            <tr>
										        ...
										        <th>所属学院（Depart）</th>
										         <th></th>
										        <th><a id="btn2" type="button" value="批量删除" onclick="deleteAsso();">删除所选</a></th>
                                        ...
                                        <tbody>
                                      <%
                                      Vector<associationsDTO> v=(Vector<associationsDTO>)session.getAttribute("allAsso");
									...
									%>
									 <thead>
									      <tr>
									       <td><input type="checkbox" name="check" value=<%=a.getAno() %>></td>
									        <td><%=a.getAno() %></td>
									        <td><%=a.getAname() %></td>
									        <td><%=a.getMno() %></td>
									        <td><%=a.getDepart() %></td>
									        <td><a href="updateAssociations.jsp?Ano=<%=a.getAno() %>">修改</a></td>
									        <td><a href="updateasso?f=delete&Ano=<%=a.getAno() %>"
